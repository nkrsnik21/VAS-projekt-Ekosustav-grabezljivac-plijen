...
Nakon toga pritisne se tipka "Pokreni simulaciju" nakon čega se simulacija pokreće i kada se izvrši u prozoru Analiza vidljivi su prikazi dijagrama, ispis podataka i mogućnost uvoza prethodnih CSV datoteka za usporedbu rezultata.
